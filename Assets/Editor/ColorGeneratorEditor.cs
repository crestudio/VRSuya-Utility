...
namespace com.vrsuya.utility {
	...
	public class ColorGeneratorEditor : EditorWindow {
		...
		void OnGUI() {
			...
			EditorGUI.DrawRect(ShadeColorBox2, MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor2.colorValue));
			EditorGUI.DrawRect(ShadeColorBox3, MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor3.colorValue));
			EditorGUI.DrawRect(ShadeColorBox4, MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor4.colorValue));
			EditorGUI.DrawRect(RimLightColorBox1, MultiplyColor(SerializedShadeColor1.colorValue, SerializedRimLightColor.colorValue));
			EditorGUI.DrawRect(RimLightColorBox2, MultiplyColor(MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor2.colorValue), SerializedRimLightColor.colorValue));
			EditorGUI.DrawRect(RimShadeColorBox1, MultiplyColor(MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor3.colorValue), SerializedRimShadowColor.colorValue));
			EditorGUI.DrawRect(RimShadeColorBox2, MultiplyColor(MultiplyColor(SerializedShadeColor1.colorValue, SerializedShadeColor4.colorValue), SerializedRimShadowColor.colorValue));
			GUILayout.BeginHorizontal();
			GUILayout.Space(BorderX);
